...
const listingTypes = [
  ...
  { value: 'medical', label: 'Affordable Medical Services' }, { value: 'community_service', label: 'Community Service' },
]
const serviceTypes = [
...
export default function ListingForm() {
  ...
  return <form onSubmit={handleSubmit} onReset={handleReset} className="space-y-6">
    ...
    <FormField label="Description" name="description" type="textarea" placeholder="Describe the listing, services, or activities..." value={formData.description} onChange={handleChange} error={errors.description} required rows={5}/>
    ...
    <FormField label={formData.listingType==='community_service'?'Activity Timing / Schedule':'Timing / Schedule'} name="timing" type="textarea" value={formData.timing} onChange={handleChange} error={errors.timing} required rows={3}/>
