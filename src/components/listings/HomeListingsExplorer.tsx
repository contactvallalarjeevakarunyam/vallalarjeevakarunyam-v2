...
const categoryDetails: Record<string, { label: string; icon: string; href: string }> = {
  ...
  community_service: { label: 'Volunteer & Community Service', icon: '🤝', href: '/volunteer' },
