...
export default async function MapPage() {
  ...
  const { data: listings, error } = await supabase.from('listings').select(`id, name, listing_type, google_maps_url, latitude, longitude, village, taluk, states(name), districts(name)`).eq('status', 'approved').eq('verification_status', 'verified').order('name')
