...
export default async function AnnadhanamPage() {
  ...
  return <main className="min-h-screen bg-gray-50">
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-10">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-8"><p className="font-semibold text-gray-900">Verification Notice</p><p className="text-sm text-gray-700 mt-2">Listings published here have been approved for public listing but may still be awaiting verification by Vallalar Jeevakarunyam administrators. Please confirm details directly before travelling.</p></div>
