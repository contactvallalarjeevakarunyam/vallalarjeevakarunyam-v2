...
export default async function TemplePage() {
  ...
  // Only approved Temple listings are shown publicly
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl">
            Discover approved temples and spiritual centres
            practicing compassion, non-violence and service to
            living beings.
          </p>
        </div>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 rounded-xl p-5">
            Unable to load Temple listings.
          </div>
        )}
          ...
          (!listings || listings.length === 0) && (
            <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
              <h2 className="text-xl font-semibold text-gray-900">
                No approved Temple listings yet
              </h2>

              <p className="text-gray-600 mt-2">
                Know a temple that should be listed? You can
