      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl">
            Find approved free or low-cost stays and accommodation
            facilities supporting pilgrims, travellers and people in need.
          </p>
        </div>
        ...
        {!error && (!listings || listings.length === 0) && (
          <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
            <h2 className="text-xl font-semibold text-gray-900">
              No approved Stay listings yet
            </h2>

            <p className="text-gray-600 mt-2">
              Know a free or low-cost stay? Submit the details for review.
            </p>
        ...
        {!error && listings && listings.length > 0 && (
          <div className="mt-10 text-center">
            ...
            <p className="text-gray-600">
              Know another free or low-cost stay?
            </p>
