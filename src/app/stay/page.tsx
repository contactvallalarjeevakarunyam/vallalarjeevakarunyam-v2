...
export default async function StayPage() {
  ...
  // Only approved Affordable Stay listings are shown publicly
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl">
            Find approved free and affordable accommodation options
            for pilgrims, travellers and people in need.
          </p>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 rounded-xl p-5">
            Unable to load Affordable Stays.
          </div>
        )}
          ...
          (!listings || listings.length === 0) && (
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900">
                No approved Affordable Stays yet
              </h2>

              <p className="text-gray-600 mt-2">
                Know a free or affordable stay? Submit the details
                for review.
              </p>
          ...
          listings.length > 0 && (
            ...
            <div className="mt-10 text-center">
              ...
              <p className="text-gray-600">
                Know another free or affordable stay?
              </p>
