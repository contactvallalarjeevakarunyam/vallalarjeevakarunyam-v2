...
export const metadata: Metadata = { title: 'Affordable Stays', description: 'Find approved free and affordable accommodation options listed on Vallalar Jeevakarunyam.' }
