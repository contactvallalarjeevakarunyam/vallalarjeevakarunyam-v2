...
export const metadata: Metadata = { title: 'Affordable Healthcare', description: 'Find approved free and affordable healthcare services, charitable medical facilities and community health initiatives listed on Vallalar Jeevakarunyam.' }
